...
\begin{itemize}
	...
	\item No ser parte del camino máximo. Como el camino máximo maximiza la longitud entre dos nodos, al ser un árbol (existen caminos para todo par de nodos), cualquier camino más lejano desde un nodo terminará en un extremo del camino máximo. Sea C1 el camino desde N1 a su hoja más lejana y sea C2 el camino máximo dentro del árbol, si C1 no terminara en un extremo de C2, como existe camino entre todo par de nodos, al terminar en otro extremo, C1 sería camino máximo y esto es absurdo, ya que C2 era el camino más largo.
\end{itemize}
