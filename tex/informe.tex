...
\begin{itemize}
	...
	\item No ser parte del camino máximo. Como el camino máximo maximiza la longitud entre dos nodos, al ser un árbol (existen caminos para todo par de nodos), cualquier camino más lejano desde un nodo terminará en un extremo del camino máximo. Sea C1, camino entre N1 y N2 (nodo más lejano, por lo que lo hace camino máximo entre N1, N2) y sea C2 camino máximo entre dos pares de nodos cuales quiera V1, V2 con V1, V2 $\neq$ N1. Si C2 $\neq$ N2, es decir, el extremo de C1 no es extremo del camino máximo (encuentra su camino más largo sin utilizar el camino máximo), entonces existe C3 con extremos en V1 y N2 de mayor longitud que C2. Absurdo, ya que C2 era el camino de mayor longitud. 
	
Por el absurdo, si N1 no pertenece al camino máximo, el extremo encontrado por BFS si.
\end{itemize}
